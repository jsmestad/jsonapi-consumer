...
class TopLevelLinksTest < MiniTest::Test
  ...
  def test_can_parse_global_links
    ...
    assert related.is_a?(JSONAPI::Consumer::ResultSet), "expected related link to return another ResultSet"
  end
  ...
  def test_can_parse_pagination_links_with_custom_config
    ...
    JSONAPI::Consumer::Paginating::Paginator.page_param = "page"
  end
  ...
  def assert_pagination
    ...
    assert page2.is_a?(JSONAPI::Consumer::ResultSet)
    ...
    assert page1.is_a?(JSONAPI::Consumer::ResultSet)
