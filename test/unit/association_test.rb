...
class AssociationTest < MiniTest::Test
  ...
  def test_has_many_fetches_relationship
    ...
    assert_equal(JSONAPI::Consumer::Query::Builder, properties_query_builder.class)
    assert_equal(Property, properties_query_builder.klass)
    assert_equal(JSONAPI::Consumer::Query::Requestor, properties_query_builder.requestor.class)
    assert_equal(JSONAPI::Consumer::ResultSet, properties.class)
